...
const Footer = () => {
  ...
  return (
    <div className='mt-5'>
        ...
        <p className=' mt-5 container-fluid p-3'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Veniam voluptates, nisi quo minus laboriosam cum nihil eveniet, vel deleniti quis maiores dolorem eaque quisquam expedita animi eum, unde doloremque aliquid.
